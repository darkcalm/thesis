...
def main():
    ...
    scopes = [
        base_dir / 'scope001 full research on automation efforts in the chemist',
        base_dir / 'scope002 Robotic Chemists_ A Comprehensive Research Survey',
        base_dir / 'scope003 most recent reviews on Control Barrier Functions',
    ]
