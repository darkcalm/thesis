...
\begin{itemize}
    \item \textbf{xxx}: Publication number from the Moth-Poulsen Publications list (193 most recent to 094 oldest)
    ...
    \item The summaries are available in: \texttt{moth-poulsen.com:publications/Moth-Poulsen Publications (193-94)\_summaries/}
\end{itemize}
