...
\begin{itemize}
    \item \textbf{scope001}: Full research on automation efforts in the chemistry lab
    \item \textbf{scope002}: Robotic Chemists - A Comprehensive Research Survey
    \item \textbf{scope003}: Most recent reviews on Control Barrier Functions
    \item Each \textbf{itemXXX} corresponds to a specific source file within the scope folder
\end{itemize}
